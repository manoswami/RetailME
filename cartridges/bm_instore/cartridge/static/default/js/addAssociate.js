 ...
 *
 * addAssociate.js - loads with the addAssociate.isml page.
 *
 */
jQuery(function() {
    ...
    function showExistingAssociatesTable() {
        $("#associateWrapperDiv").hide(500, function() {
            ...
            $(".assignAssociateFormText").show();
            $(".newAssociateFormText").hide();
            $("#newAssoc_errorTextWrapper").hide();
    ...
    function showNewAssocForm() {
        ...
        $('#associateWrapperDiv')
                .hide(
                        500,
                        function() {
                            $("#assignAssocErrorView").hide(); // hide if it is
                            // being shown
                            $("input[name=apply]").hide();
                            $("input[name=cancel]").hide();
                            $("#createNewAssoc").show();
                            $("#cancelNewAssoc").show();
                            $(".assignAssociateFormText").hide();
                            $(".newAssociateFormText").show();

...
var Countries = require('retailme_storefront_core/cartridge/scripts/util/Countries');
...
exports.initCreditCardList = guard.ensure(['https'], initCreditCardList);
exports.validateBilling = guard.ensure(['https'], validateBilling);
